...
if (is_admin()){
  ...
  $config = array(
    ...
    'pages' => array('tipo_de_producto'),        // taxonomy name, accept categories, post_tag and custom taxonomies
  ...
  //text field
  $my_meta->addText($prefix.'text_field_id',array('name'=> __('Otro dato ','tax-meta')));
  // textarea field
  // $my_meta->addTextarea($prefix.'textarea_field_id',array('name'=> __('My Textarea ','tax-meta')));
  //checkbox field
  // $my_meta->addCheckbox($p
  // efix.'checkbox_field_id',array('name'=> __('My Checkbox ','tax-meta')));
  //select field
  ...
  //Image field
  $my_meta->addImage($prefix.'image_field_id',array('name'=> __('Foto ','tax-meta')));
  //file upload field
  ...
  // $repeater_fields[] = $my_meta->addText($prefix.'re_text_field_id',array('name'=> __('Otro dato ','tax-meta')),true);
  ...
  // $repeater_fields[] = $my_meta->addImage($prefix.'image_field_id',array('name'=> __('Foto ','tax-meta')),true);
