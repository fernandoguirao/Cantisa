          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <div class="spacing sp-sm2"></div><a href="/noticias" class="text-link">
                <p class="uppercase main-color text-center"> <?php if(ICL_LANGUAGE_CODE=='en') { ?><i class="fa fa-angle-left"></i> Back to news<?php } else { ?><i class="fa fa-angle-left"></i> Volver a noticias<?php } ?>
                </p></a>
              <div class="spacing sp-sm2"></div>
            </div>
          </div>
